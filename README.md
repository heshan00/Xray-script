...
```https://github.com/heshan00/Xray-script/blob/main/Xray-TLS%2BWeb-setup.sh
缺点就是编译耗时长
## 脚本使用说明
...
### 2. 获取/更新脚本
```bash
wget -O Xray-TLS+Web-setup.sh https://github.com/heshan00/Xray-script/blob/main/Xray-TLS%2BWeb-setup.sh
```
### 3. 执行脚本
```bash
...
## 运行截图
<div>
    <img width="400" src="https://github.com/heshan00/Xray-script/blob/main/image/menu.jpg">
</div>
<div>
    <img width="600" src="https://github.com/heshan00/Xray-script/blob/main/image/protocol.jpg">
</div>
...
## 注
1.本文链接(官网)：https://github.com/heshan00/Xray-script
